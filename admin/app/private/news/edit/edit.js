 ...
 */
angular.module('yapp')
  .controller('NewsEditCtrl', function($scope, $state,profilesService,simpleObj,SeatEatsConstants,$rootScope,toastr,newsService) {
    $scope.$state = $state;
    ...
    if(angular.isDefined(simpleObj)) {
      ...
      $scope.selectedLanguage=$scope.model.language;
